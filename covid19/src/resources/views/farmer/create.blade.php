            ...
            <div class="card-body">
                ...
                <div class="shadow-sm p-3  bg-white rounded" id="question_">
                    ...
                    @if(isset($data->id_farmer) && !empty($data->id_farmer))
                        <form role="form" action="{{Route('farmer_create',$data->id_farmer)}}" method="post">
                            <input type="hidden" name="id_farmer" value="{{ isset($data->id_farmer) ? $data->id_farmer : 0 }}" id="id_farmer">
                    @else
                        <form action="{{route('farmer_create')}}" method="post">
                    @endif
                        @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12"><h4>Land physical Address with GPS location:</h4></div>
                                    </div>

                                    <div class="row">
                                        <div class="col-4" style="margin-top: 8px;">
                                            <strong><p class="text-right">Land Address Details :</p></strong>
                                        </div>
                                        <div class="col-8">
                                            <div class="form-group">
                                        <textarea
