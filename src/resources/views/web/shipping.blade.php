              ...
              <tr>
                <td >
                  ...
                  <label class="form-check-label" for="gridCheck">
                    {{$address_data->full_name ? $address_data->full_name . ',' : ''}} {{$address_data->street ? $address_data->street . ',' : ''}} {{$address_data->city ? $address_data->city . ',' : ''}} {{$address_data->zone_name ? $address_data->zone_name . ',' : ''}} {{$address_data->country_name ? $address_data->country_name . ',' : ''}} {{$address_data->postcode ? $address_data->postcode : ''}}
                  </label>
                </div>
              </td>
              <td class="edit-tag">
               ...
               @endif
                  ...
                  <div class="form-row">
                    <div class="form-group col-md-6">
                      <label for="full_name"><span class="star">*</span>@lang('website.Full Name')</label>

                        <input type="text" name="full_name" class="form-control field-validate" id="full_name" value="{{$result['editAddress'][0]->full_name ?? old('full_name')}}">
                        <span class="help-block error-content7" hidden>@lang('website.Please enter your full name')</span>
                    </div>
