						...
						<form  enctype="multipart/form-data"   action="{{ URL::to('/process-login')}}" method="post">
							{{csrf_field()}}
								<div class="from-group mb-3">
									<div class="col-12"> <label for="inlineFormInputGroup">@lang('Phone')</label></div>
						...
						<div class="registration-process">
							...
							<form name="signup" enctype="multipart/form-data"  action="{{ URL::to('/signupProcess')}}" method="post">
								...
								<div class="from-group mb-3">
									...
									<div class="from-group mb-3">
										<div class="col-12">
											<label for="inlineFormInputGroup"><strong style="color: red;">*</strong>@lang('website.phone')</label>
										</div>
										<div class="input-group col-12">
											<div class="input-group-prepend">
												<div class="input-group-text"><i class="fas fa-signature"></i></div>
											</div>
											<input  name="phone" type="text" class="form-control field-validate field-validate" id="lastName" placeholder="@lang('website.please_enter_your_phone_number')" value="{{ old('phone') }}">
											<span class="help-block" hidden>@lang('website.please_enter_your_phone_number')</span>
										</div>
									</div>
