                    ...
                    <div class="col-12 col-lg-7" >
                        ...
                        <div class="list-main">
                            ...
                            <ul class="list">
                              ...
                              <?php endif; ?>
                                <li> <?php echo e($result['detail']['product_data'][0]->products_ordered); ?>&nbsp;<?php echo app('translator')->getFromJson('website.Order(s)'); ?></li>
                                <?php if($result['detail']['product_data'][0]->products_type == 0): ?>
                                <?php if($result['detail']['product_data'][0]->defaultStock == 0): ?>
                                <li class="outstock"><i class="fas fa-check"></i><?php echo app('translator')->getFromJson('website.Out of Stock'); ?></li>
                                <?php else: ?>
                                <li class="instock"><i class="fas fa-check"></i><?php echo app('translator')->getFromJson('website.In stock'); ?></li>
                                <?php endif; ?>
                                <?php endif; ?>
                            </ul>
                        </div>
                              ...
                              <div class="buttons">
                               <?php if(!empty($result['detail']['product_data'][0]->flash_start_date) and $result['detail']['product_data'][0]->server_time < $result['detail']['product_data'][0]->flash_start_date ): ?>
                                <?php else: ?>
                                 <?php if($result['detail']['product_data'][0]->products_type == 0): ?>
                                      <?php if($result['detail']['product_data'][0]->defaultStock == 0): ?>
                                        <button class="btn  btn-block  btn-danger " type="button"><?php echo app('translator')->getFromJson('website.Out of Stock'); ?></button>
                                      <?php else: ?>
                                          <button class="btn btn-block btn-secondary add-to-Cart" type="button" products_id="<?php echo e($result['detail']['product_data'][0]->products_id); ?>"><?php echo app('translator')->getFromJson('website.Add to Cart'); ?></button>
                                      <?php endif; ?>
                                  <?php else: ?>
                                       <button class="btn btn-secondary btn-block  add-to-Cart stock-cart"  type="button" products_id="<?php echo e($result['detail']['product_data'][0]->products_id); ?>"><?php echo app('translator')->getFromJson('website.Add to Cart'); ?></button>
                                       <button class="btn btn-danger btn-block  stock-out-cart" hidden type="button"><?php echo app('translator')->getFromJson('website.Out of Stock'); ?></button>
                                  <?php endif; ?>
                                <?php endif; ?>
                              </div>
      ...
      <div class="products-area">
          <div class="row">
              <div class="col-12">
                <div class="heading">
                  <h2>
                    <?php echo app('translator')->getFromJson('website.Related Products'); ?>
                  </h2>
...
<?php /**PATH /home/maxproit/farm2home/src/resources/views/web/details/detail1.blade.php ENDPATH**/ ?>