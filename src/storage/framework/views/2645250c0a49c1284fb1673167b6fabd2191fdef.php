              ...
              <div class="row align-items-center">
                  ...
                  <div class="col-12 col-md-6">
                    <div class="footer-info">
                        © 2020 Farm2Homebd.com.  <a href="<?php echo e(url('/page?name=refund-policy')); ?>"><?php echo app('translator')->getFromJson('website.Privacy'); ?></a>&nbsp;&bull;&nbsp;<a href="term.html"><?php echo app('translator')->getFromJson('website.Terms'); ?></a>
                    </div>
...
<?php /**PATH /var/www/html/farm2homewebnew/farm2homewebnew/src/resources/views/web/footers/footer1.blade.php ENDPATH**/ ?>