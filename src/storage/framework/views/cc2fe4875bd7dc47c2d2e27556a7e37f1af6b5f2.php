                        ...
                        <form class="form-inline">
                            <div class="search">
                              ...
                              <button id="subscribe" class="btn btn-secondary subscribe" type="submit">
                                  <?php echo app('translator')->getFromJson('website.Subscribe'); ?>
                                </button>
        ...
        <div class="col-12 col-md-4 ">
          <div class="single-footer single-footer-right">
            ...
            <ul class="links-list pl-0 mb-0">
              ...
              <?php endif; ?>
                  <li> <a href="<?php echo e(URL::to('/contact')); ?>"><i class="fa fa-angle-right"></i><?php echo app('translator')->getFromJson('website.Contact Us'); ?></a> </li>
            </ul>
          </div>
        </div>
      </div>
          ...
          <div class="row align-items-center">
              ...
              <div class="col-12 col-md-6">
                <div class="footer-info">
                  © 2020 Farm2Homebd.com. <a href="<?php echo e(url('/page?name=refund-policy')); ?>"><?php echo app('translator')->getFromJson('website.Privacy'); ?></a>&nbsp;&bull;&nbsp;<a href="<?php echo e(url('/page?name=term-services')); ?>"><?php echo app('translator')->getFromJson('website.Terms'); ?></a>
                </div>
...
<?php /**PATH /var/www/html/farm2homewebnew/farm2homewebnew/src/resources/views/web/footers/mobile.blade.php ENDPATH**/ ?>