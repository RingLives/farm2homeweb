...
<section class="products-content">
    <div class="container">
     <div class="products-area">
        <!-- heading -->
        <div class="heading">
          <h2><?php echo app('translator')->getFromJson('website.Special Products of the Week'); ?>
           <small class="pull-right">
            <a href="<?php echo e(url('/shop?type=special')); ?>"><?php echo app('translator')->getFromJson('website.View All'); ?></a>
           </small>
          </h2>
          <hr>
        </div>
...
<?php endif; ?>
<?php /**PATH /var/www/html/farm2homewebnew/farm2homewebnew/src/resources/views/web/product-sections/special.blade.php ENDPATH**/ ?>