   ...
   <div class="container">
       <div class="row align-items-center justify-content-between">
           ...
           <ul class="list-group">
              ...
              <li class="list-group-item"><a href="<?php echo e(URL::to('/')); ?>"><?php echo app('translator')->getFromJson('website.Home'); ?></a></li>
              <li  class="list-group-item"><a href="<?php echo e(URL::to('/shop')); ?>"><?php echo app('translator')->getFromJson('website.Shop'); ?></a></li>
             ...
             <?php else: ?>
             <li class="list-group-item"><a href="<?php echo e(URL::to('/')); ?>"><?php echo app('translator')->getFromJson('website.Home'); ?></a></li>
             <li class="list-group-item active"><?php echo app('translator')->getFromJson('website.Shop'); ?></li>
             <?php endif; ?>
           </ul>
         </div>
       ...
       <div class="row">
         <div class="col-12 col-lg-3  d-lg-block d-xl-block right-menu">
           ...
           <form enctype="multipart/form-data" name="filters" id="test" method="get">
             ...
             ?>
                 <a href="<?php echo e(URL::to('/shop')); ?>" class="btn btn-dark" id="apply_options"> <?php echo app('translator')->getFromJson('website.Reset'); ?> </a>
                    <?php if(app('request')->input('filters_applied')==1): ?>
                ...
                <?php if(isset($result['commonContent']['homeBanners'])): ?>
                     ...
                     <div class="row">
                       <div class="col-12 col-lg-12">
                         ...
                         <div class="col-12 col-xl-6">
                           <div class="block">
                             <label><?php echo app('translator')->getFromJson('website.Display'); ?></label>
                             <label>
                         ...
                         <div class="col-12 col-xl-6">
                           <form class="form-inline" id="load_products_form">
                             ...
                             <label><?php echo app('translator')->getFromJson('website.Sort'); ?></label>
                             <div class="form-group">
                             ...
                             <label><?php echo app('translator')->getFromJson('website.Limit'); ?></label>
                             <div class="form-group">
                             ...
                             <label><?php echo app('translator')->getFromJson('website.per page'); ?></label>
...
<?php /**PATH /var/www/html/farm2homewebnew/farm2homewebnew/src/resources/views/web/shop-pages/shop1.blade.php ENDPATH**/ ?>