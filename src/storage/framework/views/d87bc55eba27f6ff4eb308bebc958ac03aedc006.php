...
<div class="container">
  <div class="row">
          ...
          <div class="row justify-content-end">
              <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><?php echo app('translator')->getFromJson('website.Order information'); ?></li>
                  </ol>
                </nav>
          </div>
      </div>
    ...
    <div class="col-12 col-lg-9 ">
        <div class="heading">
            <h2>
                <?php echo app('translator')->getFromJson('website.Order information'); ?>
            </h2>
            <hr >
          </div>
        ...
        <div class="row">
          <div class="col-12 col-md-5">
              ...
              <table class="table order-id">
                  <tbody>
                      <tr class="d-flex">
                        <td class="col-6 col-md-6"><?php echo app('translator')->getFromJson('website.orderStatus'); ?></td>
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-7">
                ...
                <table class="table order-id">
                    <tbody>
                        <tr class="d-flex">
                          <td class="col-6"><?php echo app('translator')->getFromJson('website.Shipping Method'); ?></td>
                          <td class="col-6"><?php echo e($result['orders'][0]->shipping_method); ?></td>
                        </tr>
                        <tr class="d-flex">
                            <td class="col-6"><?php echo app('translator')->getFromJson('website.Payment Method'); ?></td>
        ...
        <table class="table items">
          ...
          <thead>
            <tr class="d-flex">
              <th class="col-2"></th>
              <th class="col-3"><?php echo app('translator')->getFromJson('website.items'); ?></th>
              <th class="col-3"><?php echo app('translator')->getFromJson('website.Price'); ?></th>
              <th class="col-2"><?php echo app('translator')->getFromJson('website.Qty'); ?></th>
              <th class="col-2"><?php echo app('translator')->getFromJson('website.SubTotal'); ?></th>
            </tr>
          </thead>
          <tbody>
            <?php
...
<?php echo $__env->make('web.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/farm2homebd/public_html/src/resources/views/web/view-order.blade.php ENDPATH**/ ?>