               ...
               <?php endif; ?>
                  ...
                  <div class="form-row">
                    <div class="form-group col-md-6">
                      <label for="inputfirstname"><span class="star">*</span><?php echo app('translator')->getFromJson('website.First Name'); ?></label>
                      ...
                      <span class="help-block error-content7" hidden><?php echo app('translator')->getFromJson('website.Please enter your first name'); ?></span>
                    </div>
                    <div class="form-group col-md-6">
                      <label for="inputlastname"><?php echo app('translator')->getFromJson('website.Last Name'); ?></label>
                      ...
                      <span class="help-block error-content7" hidden><?php echo app('translator')->getFromJson('website.Please enter your address'); ?></span>                  </div>
                  </div>
                  <div class="form-row">
                    <div class="form-group col-md-6">
                    ...
                    <div class="form-group select-control col-md-6">
                      <label for="inputState"><span class="star">*</span> <?php echo app('translator')->getFromJson('website.Country'); ?></label>
                      ...
                      <span class="help-block error-content1" hidden><?php echo app('translator')->getFromJson('website.Please select your country'); ?></span>
                    </div>
                  </div>
                  <div class="form-row">
...
<?php echo $__env->make('web.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/farm2homebd/public_html/src/resources/views/web/shipping.blade.php ENDPATH**/ ?>