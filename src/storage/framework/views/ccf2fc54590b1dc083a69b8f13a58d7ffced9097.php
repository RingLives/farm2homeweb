<?php $__env->startSection('content'); ?>
                ...
                <div class="row justify-content-end">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                          ...
                          <li class="breadcrumb-item active" aria-current="page"><?php echo app('translator')->getFromJson('website.My Orders'); ?></li>
                        </ol>
                      </nav>
                </div>
            </div>
   ...
   <?php if(Auth::guard('customer')->check()): ?>
          ...
          <div class="col-12 col-lg-9 ">
              <div class="heading">
                  <h2>
                      <?php echo app('translator')->getFromJson('website.My Orders'); ?>
                  </h2>
                  <hr >
                </div>
              ...
              <table class="table order-table">
                ...
                <thead>
                  <tr class="d-flex">
                    <th class="col-12 col-md-2"><?php echo app('translator')->getFromJson('website.Order ID'); ?></th>
                    <th class="col-12 col-md-2"><?php echo app('translator')->getFromJson('website.Order Date'); ?></th>
                    <th class="col-12 col-md-2"><?php echo app('translator')->getFromJson('website.Price'); ?></th>
                    <th class="col-12 col-md-2" ><?php echo app('translator')->getFromJson('website.Status'); ?></th>
...
<?php echo $__env->make('web.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/farm2homebd/public_html/src/resources/views/web/orders.blade.php ENDPATH**/ ?>