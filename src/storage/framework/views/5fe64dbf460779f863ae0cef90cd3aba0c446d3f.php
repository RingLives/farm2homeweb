          ...
          <div class="row justify-content-end">
              <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><?php echo app('translator')->getFromJson('website.Shopping cart'); ?></li>
                  </ol>
                </nav>
          </div>
      </div>
              ...
              <div class="form-group">
                    <?php $__currentLoopData = session('coupon'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $coupons_show): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="alert alert-success">
                          ...
                          <?php echo app('translator')->getFromJson('website.Coupon Applied'); ?> <?php echo e($coupons_show->code); ?>.<?php echo app('translator')->getFromJson('website.If you do note want to apply this coupon just click cross button of this alert.'); ?>
                        </div>
            ...
            <div class="col-12 col-lg-12 mb-4">
              <div class="row justify-content-between click-btn">
                ...
                <div class="col-12 col-lg-7 align-right">
                  <a  href="<?php echo e(URL::to('/shop')); ?>" class="btn btn-outline-primary"><?php echo app('translator')->getFromJson('website.Back To Shopping'); ?></a>
               ...
               <div  id="coupon_require_error" class="help-block" style="display: none;color:red;"><?php echo app('translator')->getFromJson('website.Please enter a valid coupon code'); ?></div>
              </div>
            </div>
          </div>
          <div class="col-12 col-lg-3">
            <table class="table right-table">
              ...
              <tbody>
                ...
                <tr>
                  <th scope="row"><?php echo app('translator')->getFromJson('website.Discount(Coupon)'); ?></th>
            ...
            <a href="<?php echo e(URL::to('/checkout')); ?>" class="btn btn-secondary m-btn col-12"><?php echo app('translator')->getFromJson('website.proceedToCheckout'); ?></a>
          </div>
        </div>
      </div>
    </div>
...
<?php /**PATH /home/farm2homebd/public_html/src/resources/views/web/carts/cart1.blade.php ENDPATH**/ ?>