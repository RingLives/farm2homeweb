 ...
 jQuery(function ($) {
  jQuery.ajax({
    ...
    success: function (res) {
      ...
      $('#compare').html(res);
      message = "<?php echo app('translator')->getFromJson('website.Product is ready to compare!'); ?>";
...
<?php /**PATH /var/www/html/farm2homewebnew/farm2homewebnew/src/resources/views/web/common/scripts/addToCompare.blade.php ENDPATH**/ ?>