    ...
    <div class="products-area">
      ...
      <div class="row">
        <div class="col-12">
          <div class="heading">
            <h2>
              <?php echo app('translator')->getFromJson('website.Flash Sale'); ?>
            </h2>
...
<?php /**PATH /var/www/html/farm2homewebnew/farm2homewebnew/src/resources/views/web/product-sections/flash_sale_section.blade.php ENDPATH**/ ?>