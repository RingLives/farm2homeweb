      ...
      <div class="row">
        <div class="col-md-12">
          <div class="nav nav-pills" role="tablist">
            ...
            <a class="nav-link nav-item nav-index active show" href="#featured" id="featured-tab" data-toggle="pill" role="tab"><?php echo app('translator')->getFromJson('website.TopSales'); ?></a>
            <?php endif; ?>
            <?php if($result['special']['success']==1): ?>
            <a class="nav-link nav-item nav-index" href="#special" id="special-tab" data-toggle="pill" role="tab" ><?php echo app('translator')->getFromJson('website.Special'); ?></a>
            <?php endif; ?>
            <?php if($result['most_liked']['success']==1): ?>
            <a class="nav-link nav-item nav-index" href="#liked" id="liked-tab" data-toggle="pill" role="tab" ><?php echo app('translator')->getFromJson('website.MostLiked'); ?></a>
            <?php endif; ?>
          </div>
          <!-- Tab panes -->
                ...
                <div class="product last-product">
                  <article>
                    <div class="icons">
                      ...
                      <a href="<?php echo e(url('/shop')); ?>" class="btn btn-block btn-link"><?php echo app('translator')->getFromJson('website.View'); ?></a>
                    </div>
                  </article>
                </div>
...
<?php endif; ?>
<?php /**PATH /var/www/html/farm2homewebnew/farm2homewebnew/src/resources/views/web/product-sections/tab.blade.php ENDPATH**/ ?>