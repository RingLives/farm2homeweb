              ...
              <div class="navigation-mobile-container">
                  ...
                  <nav id="navigation-mobile">
                      <div class="logout-main">
                          ...
                          <div class="logout">
                              <a href="<?php echo e(url('logout')); ?>" class=""><?php echo app('translator')->getFromJson('website.Logout'); ?></a>
                          </div>
                          <?php endif; ?>
                      </div>
                      ...
                      <a class="main-manu btn btn-primary" data-toggle="collapse" href="#shoppages" role="button" aria-expanded="false" aria-controls="shoppages">
                          <?php echo app('translator')->getFromJson('website.infoPages'); ?><span><i class="fas fa-chevron-down"></i></span>
                      ...
                      <a class=" main-manu btn btn-primary" data-toggle="collapse" href="#productpages" role="button" aria-expanded="false" aria-controls="productpages">
                        <?php echo app('translator')->getFromJson('website.News'); ?> <span><i class="fas fa-chevron-down"></i></span>
                        <span><i class="fas fa-chevron-up"></i></span>
                      </a>
                      ...
                      <?php if(auth()->guard('customer')->check()){ ?>
                       <a href="<?php echo e(url('profile')); ?>" class="main-manu btn btn-primary"><?php echo app('translator')->getFromJson('website.Profile'); ?></a>
                       <a href="<?php echo e(url('wishlist')); ?>" class="main-manu btn btn-primary"><?php echo app('translator')->getFromJson('website.Wishlist'); ?></a>
                       <a href="<?php echo e(url('compare')); ?>" class="main-manu btn btn-primary"><?php echo app('translator')->getFromJson('website.Compare'); ?>&nbsp;(<span id="compare"><?php echo e($count); ?></span>)</a>
                       <a href="<?php echo e(url('orders')); ?>" class="main-manu btn btn-primary"><?php echo app('translator')->getFromJson('website.Orders'); ?></a>
                       <a href="<?php echo e(url('shipping-address')); ?>" class="main-manu btn btn-primary"><?php echo app('translator')->getFromJson('website.Shipping Address'); ?></a>
                       <a href="<?php echo e(url('logout')); ?>" class="main-manu btn btn-primary"><?php echo app('translator')->getFromJson('website.Logout'); ?></a>
                      <?php }else{ ?>
                        <div class="nav-link"><?php echo app('translator')->getFromJson('website.Welcome'); ?>!</div>
                         <a href="<?php echo e(URL::to('/login')); ?>" class="main-manu btn btn-primary"><i class="fa fa-lock" aria-hidden="true"></i>&nbsp;<?php echo app('translator')->getFromJson('website.Login/Register'); ?></a>
                       <?php } ?>
                  </nav>
              </div>
...
<?php /**PATH /var/www/html/farm2homewebnew/farm2homewebnew/src/resources/views/web/headers/mobile.blade.php ENDPATH**/ ?>