                ...
                <div class="form-start">
                  ...
                  <?php endif; ?>
                    <form enctype="multipart/form-data" action="<?php echo e(URL::to('/processContactUs')); ?>" method="post">
                      ...
                      <label class="first-label" for="email"><?php echo app('translator')->getFromJson('website.Full Name'); ?></label>
                      <div class="input-group">

                          <div class="input-group-prepend">
                            <span class="input-group-text" id="inputGroupPrepend"><i class="fas fa-user"></i></span>
                          </div>
                          <input type="text" class="form-control" id="name" name="name" placeholder="<?php echo app('translator')->getFromJson('website.Please enter your name'); ?>" aria-describedby="inputGroupPrepend" required>
                          <span class="help-block error-content" hidden><?php echo app('translator')->getFromJson('website.Please enter your name'); ?></span>
                      </div>
                      <label for="email"><?php echo app('translator')->getFromJson('website.Email'); ?></label>
                      <div class="input-group">
...
<?php /**PATH /home/farm2homebd/public_html/src/resources/views/web/contacts/contact1.blade.php ENDPATH**/ ?>