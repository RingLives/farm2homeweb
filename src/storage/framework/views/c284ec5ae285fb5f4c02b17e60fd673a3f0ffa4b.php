   ...
   <div class="container">
     <div class="row">
         <div class="col-12 col-sm-12">
             <div class="row justify-content-end">
                 <nav aria-label="breadcrumb">
                     <ol class="breadcrumb">
                       <li class="breadcrumb-item"><a href="#"><?php echo app('translator')->getFromJson('website.Home'); ?></a></li>
                       <li class="breadcrumb-item active" aria-current="page"><?php echo app('translator')->getFromJson('website.myProfile'); ?></li>
                     </ol>
                   </nav>
             </div>
         </div>
       ...
       <div class="col-12 col-lg-9 ">
           <div class="heading">
               <h2>
                   <?php echo app('translator')->getFromJson('website.Personal Information'); ?>
               </h2>
               <hr >
             </div>
               ...
               <?php echo csrf_field(); ?>
                ...
                <div class="form-group row justify-content-center">
                 ...
                 <div class="form-group row">
                   <label for="firstName" class="col-sm-2 col-form-label"><?php echo app('translator')->getFromJson('website.First Name'); ?></label>
                   <div class="col-sm-10">
                     <input type="text" required name="customers_firstname" class="form-control" id="inputName" value="<?php echo e(auth()->guard('customer')->user()->first_name); ?>" placeholder="<?php echo app('translator')->getFromJson('website.First Name'); ?>">
                   </div>
                 </div>
                 <div class="form-group row">
                   <label for="lastName" class="col-sm-2 col-form-label"><?php echo app('translator')->getFromJson('website.Last Name'); ?></label>
                   <div class="col-sm-10">
                     <input type="text" required name="customers_lastname" placeholder="<?php echo app('translator')->getFromJson('website.Last Name'); ?>" class="form-control field-validate" id="lastName" value="<?php echo e(auth()->guard('customer')->user()->last_name); ?>">
                   </div>
                 </div>
                 <div class="form-group row">
                   <label for="gender"  class="col-sm-2 col-form-label"><?php echo app('translator')->getFromJson('website.Gender'); ?></label>
                     <div class="col-5 col-sm-5">
                         <div class="select-control">
                             <select name="gender" required class="form-control" id="exampleSelectGender1" aria-describedby="genderHelp">
                               <option value="0" <?php if(auth()->guard('customer')->user()->gender == 0): ?> selected <?php endif; ?>><?php echo app('translator')->getFromJson('website.Male'); ?></option>
                               <option value="1"  <?php if(auth()->guard('customer')->user()->gender == 1): ?> selected <?php endif; ?>><?php echo app('translator')->getFromJson('website.Female'); ?></option>
                              </select>
                         </div>
                     </div>
                     <div class="col-7 col-sm-5">
                         <div class="input-group date">
                           <div class="input-group-prepend">
                             ...
                             <input name="customers_telephone" type="tel"  placeholder="<?php echo app('translator')->getFromJson('website.Phone Number'); ?>" value="<?php echo e(auth()->guard('customer')->user()->phone); ?>" class="form-control">
                           </div>
                     </div>
                   ...
                   <div class="form-group row">
                       ...
                       <div class="col-7 col-sm-5">
                           <div class="input-group date">
                               <input readonly name="customers_dob" type="text" data-provide="datepicker" class="form-control" placeholder="<?php echo app('translator')->getFromJson('website.Date of Birth'); ?>" value="<?php echo e(auth()->guard('customer')->user()->dob); ?>" aria-label="date-picker" aria-describedby="date-picker-addon1">
                   ...
                   <button type="submit" class="btn btn-primary"><?php echo app('translator')->getFromJson('website.Update'); ?></button>
             </form>
       ...
       <div style="margin-top:20px;"class="col-12 col-lg-9 offset-3 ">
           <div class="heading">
               <h2>
                   <?php echo app('translator')->getFromJson('website.Change Password'); ?>
               </h2>
               <hr >
             </div>
...
<?php echo $__env->make('web.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/farm2homebd/public_html/src/resources/views/web/profile.blade.php ENDPATH**/ ?>