...
<section class="products-content">
  ...
  <!-- heading -->
  <div class="heading">
    <h2><?php echo app('translator')->getFromJson('website.Newest Products'); ?>
      <small class="pull-right">
      <a href="<?php echo e(url('/shop')); ?>"><?php echo app('translator')->getFromJson('website.View All'); ?></a>
      </small>
    </h2>
    <hr>
  </div>
...
<?php endif; ?>
<?php /**PATH /var/www/html/farm2homewebnew/farm2homewebnew/src/resources/views/web/product-sections/newest_product.blade.php ENDPATH**/ ?>