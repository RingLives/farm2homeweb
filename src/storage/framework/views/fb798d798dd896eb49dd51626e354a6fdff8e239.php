         ...
         <div class="row">
           <div class="checkout-module">
             <ul class="nav nav-pills mb-3 checkoutd-nav d-none d-lg-flex" id="pills-tab" role="tablist">
                 ...
                 <li class="nav-item">
                   <a class="nav-link <?php if(session('step')==1): ?> active <?php elseif(session('step')>1): ?> active-check <?php endif; ?>" <?php if(session('step')>=1): ?> id="pills-billing-tab" data-toggle="pill" href="#pills-billing" role="tab" aria-controls="pills-billing" aria-selected="false"  <?php endif; ?> ><?php echo app('translator')->getFromJson('website.Billing Address'); ?></a>
                 </li>
                 <li class="nav-item">
                 ...
                 <div class="tab-pane fade <?php if(session('step') == 0): ?> show active <?php endif; ?>" id="pills-shipping" role="tabpanel" aria-labelledby="pills-shipping-tab">
                   <form name="signup" enctype="multipart/form-data" class="form-validate"  action="<?php echo e(URL::to('/checkout_shipping_address')); ?>" method="post">
                     ...
                     <div class="form-group">
                       ...
                       <span style="color:red;" class="help-block error-content" hidden><?php echo app('translator')->getFromJson('website.Please enter your first name'); ?></span>
                     </div>
                     <div class="form-group">
                       ...
                       <span style="color:red;" class="help-block error-content" hidden><?php echo app('translator')->getFromJson('website.Please enter your last name'); ?></span>
                     </div>
                     <?php if(Session::get('guest_checkout') == 1){ ?>
                     <div class="form-group">
                       <label for="lastName"><?php echo app('translator')->getFromJson('website.Email'); ?></label>
                       ...
                       <span style="color:red;" class="help-block error-content" hidden><?php echo app('translator')->getFromJson('website.Please enter your email'); ?></span>
                     </div>
                     <?php } ?>
                     <div class="form-group">
                       ...
                       <span style="color:red;" class="help-block error-content" hidden><?php echo app('translator')->getFromJson('website.Please enter your company name'); ?></span>
                     </div>

                     <div class="form-group">
                       <label for="exampleInputAddress1"><?php echo app('translator')->getFromJson('website.Address'); ?></label>
                       <input type="text" required class="form-control field-validate" name="street" id="street" aria-describedby="addressHelp" placeholder="<?php echo app('translator')->getFromJson('website.Please enter your address'); ?>">
                     ...
                     <div class="form-group">
                       <label for="exampleSelectCountry1"><?php echo app('translator')->getFromJson('website.Country'); ?></label>
                       ...
                       <span style="color:red;" class="help-block error-content" hidden><?php echo app('translator')->getFromJson('website.Please select your country'); ?></span>
                     </div>
                     <div class="form-group">
                 ...
                 <div class="tab-pane fade <?php if(session('step') == 1): ?> show active <?php endif; ?>"  id="pills-billing" role="tabpanel" aria-labelledby="pills-billing-tab">
                     <form name="signup" enctype="multipart/form-data" action="<?php echo e(URL::to('/checkout_billing_address')); ?>" method="post">
                       <input type="hidden" name="_token" id="csrf-token" value="<?php echo e(Session::token()); ?>" />
                         <div class="form-group">
                             <label for="exampleInputName1"><?php echo app('translator')->getFromJson('website.First Name'); ?></label>
                           ...
                           <div class="form-group">
                             <label for="exampleInputName2"><?php echo app('translator')->getFromJson('website.Last Name'); ?></label>
                           ...
                           <div class="form-group">
                             <label for="exampleInputCompany1"><?php echo app('translator')->getFromJson('website.Company'); ?></label>
                             ...
                             <div class="select-control">
                                 <select required class="form-control same_address_select" name="billing_zone_id" <?php if(!empty(session('billing_address'))>0): ?> <?php if(session('billing_address')->same_billing_address==1): ?> disabled <?php endif; ?> <?php else: ?> disabled <?php endif; ?> id="billing_zone_id" aria-describedby="stateHelp">
                                   ...
                                   <?php if(!empty($result['zones'])>0): ?>
                                     ...
                                     <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                   <?php endif; ?>
                                     <option value="-1" <?php if(!empty(session('billing_address'))>0): ?> <?php if(session('billing_address')->billing_zone_id == 'Other'): ?> selected <?php endif; ?> <?php endif; ?>><?php echo app('translator')->getFromJson('website.Other'); ?></option>
                                   </select>
                             </div>
                             <span class="help-block error-content" hidden><?php echo app('translator')->getFromJson('website.Please select your state'); ?></span>
                           </div>
                           <div class="form-group">
                               <label for="exampleSelectCity1"><?php echo app('translator')->getFromJson('website.City'); ?></label>
                             ...
                             <div class="form-group">
                                 <div class="form-check">
                                     <input class="form-check-input" type="checkbox" id="same_billing_address" value="1" name="same_billing_address" <?php if(!empty(session('billing_address'))>0): ?> <?php if(session('billing_address')->same_billing_address==1): ?> checked <?php endif; ?> <?php else: ?> checked  <?php endif; ?> > <?php echo app('translator')->getFromJson('website.Same shipping and billing address'); ?>>
                             ...
                             <div class="col-12 col-sm-12">
                             <div class="row">
                               <button type="submit"  class="btn btn-secondary"><span><?php echo app('translator')->getFromJson('website.Continue'); ?><i class="fas fa-caret-right"></i></span></button>
                               </div>
                             </div>
                       </form>
                 </div>
...
<?php echo $__env->make('web.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/farm2homebd/public_html/src/resources/views/web/checkout.blade.php ENDPATH**/ ?>