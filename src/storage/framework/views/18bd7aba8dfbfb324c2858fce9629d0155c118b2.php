  <?php if($result['news']['success']==1): ?>
      ...
      <section class="blog-content">
        ...
        <div class="container">
          <!-- heading -->
          <div class="heading">
              <h2><?php echo app('translator')->getFromJson('website.From our News'); ?>
                <small class="pull-right">
                <a href="<?php echo e(URL::to('/news')); ?>"><?php echo app('translator')->getFromJson('website.View All'); ?></a>
                </small>
              </h2>
              <hr>
            </div>
              ...
              <div class="col-12 col-sm-6 col-lg-4 blog-col">
                <div class="blog">
                    <h2><a href="<?php echo e(URL::to('/news-detail/'.$news_data->news_slug)); ?>"><?php echo e($news_data->news_name); ?></a>
                        <span class="featured-tag"><?php echo app('translator')->getFromJson('website.Featured'); ?></span>
                      </h2>
                    <div class="blog-date">
                      <?php
  ...
  <?php endif; ?>
<?php /**PATH /var/www/html/farm2homewebnew/farm2homewebnew/src/resources/views/web/product-sections/blog_section.blade.php ENDPATH**/ ?>