...
class Order extends Model
{
  ...
  //place_order
	public function place_order($request)
	{
		...
		$delivery_full_name =   session('shipping_address')->full_name ?? '';
		...
		$billing_full_name =   session('billing_address')->full_name ?? '';
			...
			if($payment_status=='success'){
				$orders_id = DB::table('orders')->insertGetId(
					[	 'customers_id' => $customers_id,
						 'customers_name'  => $delivery_full_name ?? (trim($delivery_firstname.' '.$delivery_lastname)),
						...
						// 'customers_address_format_id' => $delivery_address_format_id,
						 ...
						 'delivery_name'  =>  $delivery_full_name ?? (trim($delivery_firstname.' '.$delivery_lastname)),
						...
						// 'delivery_address_format_id' => $delivery_address_format_id,
						 ...
						 'billing_name'  => $billing_full_name ?? (trim($billing_firstname.' '.$billing_lastname)),
