...
class Shipping extends Model
{
	...
	public function addMyAddress($request){
		...
		$entry_street_address =   $request->entry_street_address ?? $request->get('street');
		$entry_suburb =   $request->entry_suburb ?? '';
		$entry_postcode =   $request->entry_postcode ?? $request->get('postcode');
		$entry_city =   $request->get('entry_city') ?? $request->get('city');
		$entry_state =   $request->entry_state ?? '';
		$entry_country_id =   $request->entry_country_id ?? '';
		$entry_zone_id =   $request->entry_zone_id ?? $request->zone_id;
