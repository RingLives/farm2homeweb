...
public static function generatebraintreetoken()
{
  ...
  if($authenticate==1){
    ...
    $payments_setting = Orders::payments_setting_for_brain_tree(request()->all());
    ...
    foreach($shippings as $shipping_methods){
      ...
      if($shipping_methods->methods_type_link == 'upsShipping' and $shipping_methods->status == '1'){
        ...
        $some_data = array(
          ...
          curl_close($curl);
         $ups_description = DB::table('shipping_description')->where('table_name','ups_shipping')->where('language_id',isset($request->language_id) ? $request->language_id : 1)->get();
        ...
        $description = DB::table('shipping_description')->where('table_name','flate_rate')->where('language_id',isset($request->language_id) ? $request->language_id : 1)->get();
        ...
        $description = DB::table('shipping_description')->where('table_name','local_pickup')->where('language_id',isset($request->language_id) ? $request->language_id : 1)->get();
        ...
        $description = DB::table('shipping_description')->where('table_name','free_shipping')->where('language_id',isset($request->language_id) ? $request->language_id : 1)->get();
        ...
        $description = DB::table('shipping_description')->where('table_name','shipping_by_weight')->where('language_id',isset($request->language_id) ? $request->language_id : 1)->get();
        if(!empty($description[0]->name)){
          $methodName = $description[0]->name;
        }else{
      ...
      foreach($order as $data){
        ...
        foreach($orders_products as $orders_products_data){
          ...
          $categories = DB::table('products_to_categories')
                  ...
                  ->where('categories_description.language_id','=',isset($request->language_id) ? $request->language_id : 1)->get();
