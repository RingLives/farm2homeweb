...
class Product extends Model
{
  ...
  {
      $language_id = (isset($request->language_id) && !empty($request->language_id)) ? $request->language_id : 1;
      ...
      if ($authenticate == 1) {
          ...
          if (!empty($request->filters)) {
                      ...
                      foreach ($getProducts as $getProduct) {
                          if (!in_array($getProduct->products_id, $eliminateRecord)) {
                              ...
                              foreach ($products as $products_data) {
                                ...
                                $requested_currency = (isset($request->currency_code) && !empty($request->currency_code)) ? $request->currency_code : 'BDT';
              ...
              if ($type == "flashsale") { //flashsale
                  $categories->where('flash_sale.flash_status', '=', '0')->where('flash_expires_date', '>', $currentDate);
              }
              //  else {
